...
df_gex <- read.csv("/Users/kevinlin/Library/CloudStorage/Dropbox/Collaboration-and-People/turbo/git/morpho_integration/csv/kevin/Writeup6_turbo-csvs/patchseq_GeoAdvAE_umap_gene_expression.csv",
                   row.names = 1)
df_morph <- read.csv("/Users/kevinlin/Library/CloudStorage/Dropbox/Collaboration-and-People/turbo/git/morpho_integration/csv/kevin/Writeup6_turbo-csvs/patchseq_GeoAdvAE_umap_morphology.csv",
                     row.names = 1)
...
png(paste0(plot_folder, "Writeup6b_umap-integration.png"),

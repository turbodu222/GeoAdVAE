...
while True:
    for it, batch in enumerate(train_loader):
        ...
        if (iterations + 1) % config['snapshot_save_iter'] == 0:
            ...
            save_plots_with_celltype_colors(trainer, data_a, data_b, image_directory, str(iterations), config)
        ...
        if iterations >= max_iter:
            ...
            save_plots_with_celltype_colors(trainer, data_a, data_b, image_directory, "final", config)
